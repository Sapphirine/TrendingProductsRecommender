...
root.plotData = (selector, data, plot) ->
  ...
  url = "http://35.211.101.139:8081/wordcount/keywords"
  ...
  datasetCoffee = {"ps4": 1449, "play-doh": 17, "game": 8955, "melissa_and_doug": 1, "oreos": 193, "nintendo": 2191, "apple": 1416, "xbox": 1002, "gaming": 2094, "playstation": 932, "switch": 3980, "delicious_chips": 5, "play_doh": 10, "cheetos": 242, "keebler": 7, "panasonic": 37, "pringles": 102, "k'nex": 3, "dell": 270, "knex": 16, "samsung": 385};

  obj = get_json
  res = ["name,count"]

  for x of obj
    if obj.hasOwnProperty(x) == true then res.push x + "," + obj[x]
